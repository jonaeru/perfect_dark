...
#else // All in One Mod
	{ STAGE_EXTRA2,           10,  5000,    0,     0,    0, 996, 1000, RGB(0x280000), NO_SUNS,            1, 10000,    0, RGB(0xdc0014), 0,  -1000, 0, RGB(0x000000), 0  }, // Complex (GE-X)
	{ STAGE_EXTRA6,           10,  6000,    0,     0,    0, 996, 1000, RGB(0x181818), NO_SUNS,            1, 10000,    0, RGB(0x787878), 0,  -1000, 0, RGB(0x000000), 0  }, // Temple (GE-X)
...
struct nofogenvironment g_NoFogEnvironments[] = {
...
#else // All in One Mod
	{ -1,                  15, 10000,   0,  0,  0, RGB(0x000000), NO_SUNS,            0, RGB(0xffffff),  5000,   0, 0, RGB(0x000000),      0,    0, 0, 0 }, // Default (GE-X)
#endif
	...
	{ STAGE_EXTRA8,        15, 10000,   0,  0,  0, RGB(0x000008), NO_SUNS,            1, RGB(0x46c7ba),  4500,   0, 0, RGB(0x000000),  -5000,    0, 0, 0 }, // Caves (GE-X)
	...
	{ STAGE_TEST_ARCH,     10, 10000,   0,  0,  0, RGB(0x000000), NO_SUNS,            0, RGB(0x3a1100),  5000,   0, 0, RGB(0x000000),      0,    0, 0, 1 }, // Suburb (Same as Defection)
	{ STAGE_TEST_MP2,      15, 20000,   0,  0,  0, RGB(0x000000), NO_SUNS,            0, RGB(0xffffff),  5000,   0, 0, RGB(0x000000),  -5000,    0, 0, 0 }, // Stack
	{ STAGE_TEST_MP6,      15, 20000,   0,  0,  0, RGB(0x001050), NO_SUNS,            1, RGB(0xffffff),  5000,   0, 0, RGB(0x000000),  -5000,    0, 0, 0 }, // Caves (PD Plus)
