...
#else // All in One Mod
#define MPBODY_CONNERY          0x3c
#define MPBODY_MOORE            0x3d
#define MPBODY_DALTON           0x3e
#define MPBODY_DJBOND           0x3f
#endif
...
#define MPOPTION_EXPLODESIMONDEATH      0x10000000
#endif
...
#define HEAD_XENIA            0x99
#define HEAD_TREVELYAN        0x9a
#define HEAD_OURUMOV          0x9b
#define HEAD_BROSNAN          0x9c
#define HEAD_DALTON           0x9d
#define HEAD_CONNERY          0x9e
#define HEAD_MOORE            0x9f
#define HEAD_LAZENBY          0xa0
#define HEAD_JAWS             0xa1
#define HEAD_SNOWGUARD        0xa2
#define HEAD_BROSNAN2         0xa3
#define HEAD_ODDJOB           0xa4
#define HEAD_DAVED            0xa5
#define HEAD_DAVED2           0xa6
#define HEAD_MISHKIN          0xa7
#define HEAD_BORIS            0xa8
#define HEAD_VALENTIN         0xa9
#define HEAD_MAYDAY           0xaa
#define HEAD_BARONSAMEDI      0xab
#define HEAD_BARONSAMEDI2     0xac
#define HEAD_BALACLAVA        0xad
#define HEAD_DWAYNE           0xae
#define HEAD_SANTA            0xaf
#define HEAD_ELF              0xb0
#define HEAD_PILOT            0xb1
#define HEAD_MARION           0xb2
#define HEAD_KARL             0xb3
#define HEAD_KARL2            0xb4
#define HEAD_MARTIN           0xb5
#define HEAD_MARK0            0xb6
#define HEAD_DUNCAN0          0xb7
#define HEAD_DUNCAN01         0xb8
#define HEAD_JONES0           0xb9
#define HEAD_GRANT0           0xba
#define HEAD_ROBIN0           0xbb
#define HEAD_GRAEME           0xbc
#define HEAD_GRAEME2          0xbd
#define HEAD_STEVE_E          0xbe
#define HEAD_KEN0             0xbf
#define HEAD_MANDY            0xc0
#define HEAD_VIVIEN           0xc1
#define HEAD_SALLY            0xc2
#define HEAD_JOEL0            0xc3
#define HEAD_JOE2             0xc4
#define HEAD_JOE              0xc5
#define HEAD_SCOTT_H0         0xc6
#define HEAD_STEVEH           0xc7
#define HEAD_JIM              0xc8
#define HEAD_JIM2             0xc9
#define HEAD_NEIL0            0xca
#define HEAD_LEE              0xcb
#define HEAD_CHRIS            0xcc
#define HEAD_CHRIS2           0xcd
#define HEAD_DES              0xce
#define HEAD_SHAUN0           0xcf
#define HEAD_PETE             0xd0
#define HEAD_ALAN             0xd1
#define HEAD_BANDOVERFLOW     0xd2
#define HEAD_WRECK            0xd3
#define HEAD_SUBDRAG          0xd4
#define HEAD_GALORE           0xd5
#define HEAD_SOGUN            0xd6
#define HEAD_MRKANE           0xd7
#define HEAD_PARIS            0xd8
#define HEAD_DONKEY           0xd9
#define HEAD_CASEYDARK        0xda
#define HEAD_HAMM             0xdb
#define HEAD_DRNO             0xdc
#define HEAD_WAILIN           0xdd
#define HEAD_AURIC            0xde
#define HEAD_ELEKTRA          0xdf
#define HEAD_MRX              0xe0
#define HEAD_SKEDAR           0xe1
#define HEAD_CARROLL          0xe2
#define HEAD_CARROLL_SINISTER 0xe3
#define HEAD_CHRISTMASJONES   0xe4
#define HEAD_CJ               0xe5
#define HEAD_MACTONIGHT       0xe6
#define BODY_NATALYA          0xe7
#define BODY_XENIA            0xe8
#define BODY_TREVELYAN        0xe9
#define BODY_OURUMOV          0xea
#define BODY_SPICEBOND        0xeb
#define BODY_DJBOND2          0xec
#define BODY_DALTON2          0xed
#define BODY_CONNERY2         0xee
#define BODY_MOORE2           0xef
#define BODY_LAZENBY          0xf0
#define BODY_JAWS             0xf1
#define BODY_SNOWGUARD        0xf2
#define BODY_SNOWBOND         0xf3
#define BODY_ODDJOB           0xf4
#define BODY_TECHMAN          0xf5
#define BODY_GREATGUARD       0xf6
#define BODY_SUITBOND         0xf7
#define BODY_BOILERBOND       0xf8
#define BODY_BOILERTREV       0xf9
#define BODY_TIMBERBOND       0xfa
#define BODY_ELTONWAISTCOAT   0xfb
#define BODY_BORIS            0xfc
#define BODY_VALENTIN         0xfd
#define BODY_MAYDAY           0xfe
#define BODY_BARONSAMEDI      0xff
#define BODY_BARONSAMEDI2     0x100
#define BODY_SANTA            0x101
#define BODY_ELF              0x102
#define BODY_OLIVEGUARD       0x103
#define BODY_PILOT            0x104
#define BODY_TREVGUARD        0x105
#define BODY_ARMOURGUARD      0x106
#define BODY_GREATGUARD2      0x107
#define BODY_BLUECAMGUARD     0x108
#define BODY_BLUEMAN          0x109
#define BODY_GREYMAN          0x10a
#define BODY_MOONGUARD        0x10b
#define BODY_MOONFEMALE       0x10c
#define BODY_CAMGUARD         0x10d
#define BODY_GREYGUARD        0x10e
#define BODY_RUSGUARD         0x10f
#define BODY_COMMGUARD        0x110
#define BODY_NAVYGUARD        0x111
#define BODY_FATTECHWOMAN     0x112
#define BODY_TECHWOMAN        0x113
#define BODY_JEANWOMAN        0x114
#define BODY_BLUEWOMAN        0x115
#define BODY_CARDIMAN         0x116
#define BODY_CHECKMAN         0x117
#define BODY_REDMAN           0x118
#define BODY_BONDALPS         0x119
#define BODY_BONDRANCH        0x11a
#define BODY_GALOREPLANE      0x11b
#define BODY_GALORERANCH      0x11c
#define BODY_SOGUNTRON        0x11d
#define BODY_CARROLL3         0x11e
#define BODY_NATALYA_XMAS     0x11f
#define BODY_NATALYA_ELF      0x120
#define BODY_CASEYDARK        0x121
#define BODY_EVERETTHAMM      0x122
#define BODY_XENIA_XMAS       0x123
#define BODY_MRX              0x124
#define BODY_SILVERWOMAN      0x125
#define BODY_JAWS_BLUE        0x126
#define BODY_FEMSPY_BLU       0x127
#define BODY_CJ               0x128
#endif
